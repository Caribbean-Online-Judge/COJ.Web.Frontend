...
function GlobalList(): JSX.Element {
   return (
      <>
         <h2 className="postheader">spring:message code="pagehdr.pcsglist"</h2>

         <form id="filter-form" className="form-inline">
            <table className="login filters">
               <tr className="filter">
              ...
              className="btn btn-primary" value="<spring:message code=" button.filter"/>"></td> */}
               </tr>
            </table>
         </form>
         ...
         <div className="postcontent">
            <div
               ...
               data-reload-url="/tables/globallist.xhtml"
            ></div>
         </div>
         {/* <script>
