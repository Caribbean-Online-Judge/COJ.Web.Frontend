...
function CreateVC(): JSX.Element {
   return (
      ...
      <div className="postcontent">
        <form method="post" onsubmit="return SeleccionarRangosVirtualContest();" commandName="contest">

          <table className="createnewuser">

            <tr>
              <td>
                spring:message code="fieldhdr.virtual" <radiobutton path="style" value="1" onchange="changeProblemsState()" id="virtual_style" />
              </td>

              <td>
                spring:message code="fieldhdr.freeprob" <radiobutton path="style" value="2" onchange="changeProblemsState()" id="free_problems_style" />
              </td>
            </tr>
