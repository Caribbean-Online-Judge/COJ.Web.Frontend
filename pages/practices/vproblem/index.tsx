  ...
  return (
    <>
      ...
      <div className="postcontent">
        <table className="navigating" width="100%">
          <tr>
        ...
        {/* <p className="ex"><c:url value="${problem.description}"/></p> */}
        ...
        <table className="pinfo">
          <tbody>
            ...
            <tr>
              <td>spring:message code="fieldhdr.outputlimit" </td>
              <td>64</td>
            </tr>
