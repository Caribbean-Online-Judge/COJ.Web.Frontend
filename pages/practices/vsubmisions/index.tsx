...
function Vsubmisions(): JSX.Element {
  return (
    <>
      ...
      <div className="postcontent">
        ...
        <table className="volume">
          <thead>
            ...
            <th className="user">spring:message code="tablehdr.user"</th>
            <th>spring:message code="tablehdr.prob"</th>
            <th className="result">spring:message code="tablehdr.judgment"</th>
            <th>spring:message code="tablehdr.time"</th>
            <th className="headmem">spring:message code="tablehdr.mem"</th>
            <th className="headsize">spring:message code="tablehdr.size"</th>
            <th className="headlang">spring:message code="tablehdr.lang"</th>
          </thead>
          {/* <tr>
